...
Agent determination can be dynamic: the BAdI method `GET_ACTORS` determines the right approver at runtime, depending on document data such as purchasing organization, material group or order value.
