# Siebzehn Sätze, die sich bewährt haben
...
| 6 | **Inkognito zeigt den Server, das normale Fenster den Cache.** Beide alt → App-Index. Nur eines alt → Browser-Storage. *Der zweite Fall verschwindet, sobald gebaut statt Datei für Datei gepflegt wird.* |
...
| 17 | **Die App ist Quelltext, kein Systemobjekt.** Sie gehört in ein Repository, wird gebaut und hochgeladen — sonst ist sie acht Dateien mit acht Altersständen, und die Frage „welcher Stand läuft eigentlich" hat keine Antwort. *Und das Repository gehört dem, dem die App gehört.* |
