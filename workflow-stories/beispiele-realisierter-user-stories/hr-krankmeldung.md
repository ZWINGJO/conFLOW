...
Ein Mitarbeiter meldet sich krank. Die Information muss zuverlässig bei der Personalabteilung ankommen, dort bearbeitet und dokumentiert werden. Ohne Workflow geschieht das per Telefon oder E-Mail -- unstrukturiert, nicht nachvollziehbar und abhängig davon, ob der richtige Ansprechpartner erreichbar ist.
...
| Bearbeitung | Personalabteilung | Erhält ein Workitem, prüft und bestätigt die Meldung |
...
{% hint style="success" %}
**Dieser Workflow dient auch als Grundlage für das [How-To](../../how-to-beispielimplementierung/beispiel-workflow-krankmeldung/)** -- dort wird Schritt für Schritt gezeigt, wie er aufgebaut wird.
{% endhint %}
