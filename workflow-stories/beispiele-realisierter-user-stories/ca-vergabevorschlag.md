...
Die Wertgrenze lässt sich heute als Regel im Customizing abbilden, mit einem Template für den Beleg. Die Bearbeiterfindung kann über eine PFCG-Rolle oder dynamisch erfolgen: die BAdI-Methode `GET_ACTORS` ermittelt den richtigen Freigeber zur Laufzeit, abhängig von Belegdaten wie Einkaufsorganisation, Warengruppe oder Bestellwert.
